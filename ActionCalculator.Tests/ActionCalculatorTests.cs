...
namespace ActionCalculator.Tests
{
    public class ActionCalculatorTests
    {
        ...
        [InlineData("Dribl:D3,F8", 1, 0.51852)]
        ...
        [InlineData("Grak^:D4,2D3,K8", 1, 0.42535, 0.47852)]
        ...
        [InlineData("Jordell:D3,2D2;DC:C2", 1, 0.42010, 0.58704)]
        [InlineData("Jordell:D3", 1, 0.90741, 0.91512)]
        [InlineData("Jordell:E3", 1, 0.66667, 0.81481)]
        [InlineData("Jordell:R2", 1, 0.83333, 0.91898)]
        ...
        [InlineData("Rashnack:T8,J8", 0, 0.17361)]
        [InlineData("Rodney:C3", 0, 0.88889)]
        [InlineData("Rowana:E3,D3,2D2", 1, 0.43896, 0.53650)]
        [InlineData("Ripper:2D3,K8", 1, 0.51042)]
        [InlineData("Ripper:D3,2D2", 1, 0.62551)]
        ...
        [InlineData("Varag:1D3%,2D3,K8", 1, 0.30990, 0.42611)]
        [InlineData("Varag*:1D3%,2D3,K8", 1, 0.39502, 0.46676)]
        [InlineData("Varag:1D3%,2D3,K8~S2", 1, 0.27083, 0.37240)]
        [InlineData("Varag*:1D3%,2D3,K8~S2", 1, 0.34523, 0.40792)]
        [InlineData("Wilhelm:2D2,K9,J8", 1, 0.15271, 0.18665)]
        [InlineData("Willow:2D3,K8", 1, 0.35880, 0.36314)]
