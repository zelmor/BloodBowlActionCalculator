namespace ActionCalculator.Models
{
    ...
    {
        public static IReadOnlyList<StarPlayerRule> All { get; } =
        [
            ...
            new(StarPlayer.BryceTheSlice,               StarPlayerSkill.GhostlyFlames,          ["Chainsaw", "Regeneration", "Loner (4+)", "Stand Firm", "Secret Weapon"],                                                              "L4"),
            ...
            new(StarPlayer.Dribl,                       StarPlayerSkill.ASneakyPair,            ["Dirty Player", "Dodge", "Loner (4+)", "Quick Foul", "Sidestep", "Sneaky Git", "Stunty"],                                              "D,L4,DP1,SG"),
            new(StarPlayer.Drull,                       StarPlayerSkill.ASneakyPair,            ["Dodge", "Loner (4+)", "Sidestep", "Stab", "Stunty"],                                                                                  "D,L4"),
            ...
            new(StarPlayer.Grak,                        StarPlayerSkill.IllCarryYou,            ["Bone Head", "Kick Team-mate", "Loner (4+)", "Mighty Blow", "Thick Skull"],                                                            "MB,L4,BT3,D"),
            ...
            new(StarPlayer.JordellFreshbreeze,          StarPlayerSkill.SwiftAsTheBreeze,       ["Block", "Diving Catch", "Dodge", "Leap", "Loner (4+)", "Sidestep", "Steady Footing"],                                                 "D,DC,L4,SFO"),
            ...
            new(StarPlayer.LucienSwift,                 StarPlayerSkill.WorkingInTandem,        ["Block", "Loner (4+)", "Mighty Blow", "Tackle"],                                                                                       "MB,L4,WIT"),
            ...
            new(StarPlayer.RashnackBackstabber,         StarPlayerSkill.ToxinConnoisseur,       ["Loner (4+)", "Shadowing", "Sidestep", "Sneaky Git", "Stab"],                                                                          "L4,SG"),
            ...
            new(StarPlayer.SkrullHalfheight,            StarPlayerSkill.StrongPassingGame,      ["Accurate", "Loner (4+)", "Nerves Of Steel", "Pass", "Regeneration", "Sure Hands", "Thick Skull"],                                     "SH,PA,L4,SPG"),
            ...
            new(StarPlayer.VaragGhoulChewer,            StarPlayerSkill.KrumpAndSmash,          ["Block", "Hatred (Undead)", "Jump Up", "Loner (4+)", "Mighty Blow", "Thick Skull", "Unsteady"],                                        "MB,L4,H,KS"),
